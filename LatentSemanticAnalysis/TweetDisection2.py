...
def processWordCount(jsonFile,tweet_text,tweet_geo):
	wordList = tweetTokenizer(tweet_text)	
	city =  getCity.getCity(tweet_geo[1],tweet_geo[0])
...
#wordList =  tweetTokenizer(tweet_text[0])
processWordCount(testJson,tweet_text[0],tweet_geo[0])
